...
git clone --depth=1 https://$USERNAME:$TOKEN@github.com/strongreasons/kernel_asus_sdm660 -b hmp-12 $DEVICE_CODENAME
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 [Hayzel][$KERNELNAME]-HMP-$DEVICE_CODENAME-LV-4.4.205.zip *
    cd ..
}
compile
zipping
