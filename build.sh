...
# Clone Kernel Source
git clone --depth=1 https://$USERNAME:$TOKEN@github.com/strongreasons/kernel_asus_sdm660 -b eas-oc-nlv $DEVICE_CODENAME
...
make -j$(nproc) ARCH=arm64 O=out \
   ...
   git clone $ANYKERNEL -b eas-nlv AnyKernel
	cp $IMAGE AnyKernel
}
