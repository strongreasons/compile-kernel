...
mkdir $ClangPath
rm -rf $ClangPath/*
wget -q https://android.googlesource.com/platform/prebuilts/clang/host/linux-x86/+archive/refs/heads/master/clang-r468909b.tar.gz -O "clang-r468909b.tar.gz"
tar -xf clang-r468909b.tar.gz -C $ClangPath
